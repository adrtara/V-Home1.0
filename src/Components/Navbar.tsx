      ...
      <nav className="fixed top-0 left-0 right-0 md:left-24 md:right-24 z-50 bg-[#fbfbf5]">
        <div className="max-w-8xl mx-auto px-8">
          <div className="flex items-center justify-between h-24 lg:grid lg:grid-cols-3">
            {/* Logo */}
            <div className="text-[26px] font-zain text-slate-800 tracking-wide flex items-center">
              <img src="https://i.postimg.cc/BnjzvK3Z/Logo-Senza-Sfondo.png" alt="V Logo" className="inline-block h-6 -translate-y-[5px] -mr-1 relative" />
              <span> 
                ospra.
              </span>
            </div>
