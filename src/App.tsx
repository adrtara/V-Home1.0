...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="hidden x1:block fixed top-0 left-0 w-24 h-full bg-slate-50 z-40" />
      <div className="hidden x1:block fixed top-0 right-0 w-24 h-full bg-slate-50 z-40" />
          ...
          <div className="flex items-center justify-between h-24">
            ...
            <div className="text-3xl font-zain text-slate-800 tracking-wide flex items-center">
              ...
              <span className="relative top-[6px]"> 
                ospra. Per Chi Non Delega Il Proprio Destino.
              </span>
            </div>
      ...
      <div className="mt-24 min-h-[calc(100vh-6rem)] md:h-[calc(100vh-6rem)] flex flex-col md:flex-row relative px-4 md:px-24">
        ...
        <div className="relative w-full md:w-1/2 h-[50vh] md:h-full overflow-hidden cursor-pointer group">
          ...
          <div className="relative h-full flex flex-col justify-center items-center md:items-start pl-0 md:pl-32 text-white">
            <div className="text-center">
              <h2 className="text-4xl font-dm-serif-text tracking-wider transition-transform duration-1000 ease-out group-hover:scale-90">STRATEGY</h2>
            </div>
          </div>
        </div>
      </div>
