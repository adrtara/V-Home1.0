      ...
      <div className="h-screen flex relative px-32">
        ...
        <div className="relative w-1/2 overflow-hidden cursor-pointer group">
          ...
          <div className="relative h-full flex flex-col justify-center items-end pr-32 text-white">
            <div className="text-center">
              <h2 className="text-6xl font-dm-serif-text tracking-wider transition-transform duration-1000 ease-out group-hover:scale-90">VENDI</h2>
            </div>
          </div>
        </div>
        ...
        <div className="relative w-1/2 overflow-hidden cursor-pointer group">
          ...
          <div className="relative h-full flex flex-col justify-center items-start pl-32 text-white">
            <div className="text-center">
              <h2 className="text-6xl font-dm-serif-text tracking-wider transition-transform duration-1000 ease-out group-hover:scale-90">ACQUISTA</h2>
            </div>
          </div>
        </div>
      </div>
