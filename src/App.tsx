        ...
        <div className="relative w-full md:w-1/2 h-[50vh] md:h-full overflow-hidden cursor-pointer group flex items-center justify-center md:justify-start">
          ...
          <div className="relative text-white z-10">
            <div className="text-center md:text-left md:ml-40 relative">
              ...
              <p className="text-xl font-normal mt-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-500 text-center md:absolute md:top-full md:left-1/2 md:transform md:-translate-x-1/2 md:mt-2 md:whitespace-nowrap">Soluzioni strategiche per <br />business digitali.</p>
            </div>
          </div>
        </div>
      </div>
