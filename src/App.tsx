        ...
        <div className="relative w-full md:w-1/2 h-[50vh] md:h-full overflow-hidden cursor-pointer group flex items-center justify-center md:justify-end">
          ...
          <div className="relative text-white z-10">
            <div className="text-center md:text-right md:mr-32 relative">
              <h2 className="text-4xl font-dm-serif-text tracking-wider transition-transform duration-1000 ease-out group-hover:scale-90 text-center md:absolute md:top-full md:left-1/2 md:transform md:-translate-x-1/2 md:whitespace-nowrap">MARKET</h2>
