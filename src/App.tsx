          ...
          <div className="flex items-center justify-between h-24">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#about" className="text-slate-600 hover:text-slate-900 font-medium transition-colors duration-200 flex items-center">
                About <img src={logoImage} alt="Logo" className="inline-block h-8 ml-1 align-middle" />
              </a>
        ...
        <div className="relative w-1/2 overflow-hidden cursor-pointer group">
          ...
          <div className="relative h-full flex flex-col justify-center items-end pr-32 text-white">
            <div className="text-center">
              <h2 className="text-7xl font-dm-serif-text tracking-wider transition-transform duration-1000 ease-out group-hover:scale-90">VENDI</h2>
            </div>
          </div>
        </div>
